function [x, Lerr, smat, xarr]=p_cvx_prekernel(v,x)
% P_CVX_PREKERNEL computes from (v,x) a pre-kernel element using CVX
% and Matlab's PCT.
...
%
% Usage: [x Lerr smat xarr] = p_cvx_prekernel(v,x)
%
% Define variables:
%  output:
