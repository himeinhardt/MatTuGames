function [ADGP ADGPC]=p_Anti_Derived_game_propertyQ(v,x,str,tol)
...
%
% Usage: [ADGP ADGPC]=p_Anti_Derived_game_propertyQ(v,x,str,tol)
% Define variables:
%  output: Fields
...
vS=cell(N-1,1);
if strcmp(str,'SHAP')
  vS=p_HMS_Anti_Derived_game(v,x,'SHAP');
elseif strcmp(str,'HMS_APK')
  vS=p_HMS_Anti_Derived_game(v,x,'APRK');
elseif strcmp(str,'HMS_APN')
  vS=p_HMS_Anti_Derived_game(v,x,'APRN');
elseif strcmp(str,'HMS_MODIC')
  vS=p_HMS_Anti_Derived_game(v,x,'MODIC');
else
  vS=p_DM_Anti_Derived_game(v,x);
end
