function [sv,wC]=p_tricameral_assembly(n,b,c)
% P_TRICAMERAL_ASSEMBLY computes from a set of parameters a simple game using Matlab's PCT. 
%
%  Source: P. Dubey and L. S. Shapley (1954), Mathematical Properties of the Banzhaf Power Index.
%
% Usage: sv=p_tricameral_assembly(n,b,c)
%
% Define variables:
%  output:
...
% Then call 
%
% [sv,wC]=p_tricameral_assembly(9,3,5)
%
