function nJI=p_NetworkJohnston(E,th,w)
% P_NETWORKJOHNSTON computes the network Johnston power index from the set of winning coalitions of a network E
