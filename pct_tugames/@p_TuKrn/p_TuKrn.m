classdef p_TuKrn < p_TuSol
% TUPRK creates the subclass object p_TuKrn to perform several computations for retrieving 
...
%
% Usage: clv = p_TuKrn(v,'gtype','gformat')
%
% Define variables:
% output:
% clv           -- p_TuKrn class object (subclass of TuGame).
%
% input:
...
%
% p_TuKrn methods:
%  p_TuKrn                       -- creates the class object p_TuKrn.
%  p_setAllVendorKrn             -- sets all computed kernel elements to p_TuKrn.
%  p_setCplexKrn                 -- sets the computed kernel element dervied with the interface CPLEX to p_TuKrn. 
%  p_setCvxKrn                   -- sets the computed kernel element dervied with the interface CVX to p_TuKrn. 
%  p_setGurobiKrn                -- sets the computed kernel element dervied with the interface GUROBI to p_TuKrn. 
%  p_setIpoptKrn                 -- sets the computed kernel element dervied with the interface IPOPT to p_TuKrn. 
%  p_setMskKrn                   -- sets the computed kernel element dervied with the interface MOSEK to p_TuKrn. 
%  p_setOasesKrn                 -- sets the computed kernel element dervied with the interface OASES to p_TuKrn. 
%  copyTuSol                   -- copies all solutions from TuSol/p_TuSol to p_TuKrn.
%  copy_p_TuKrn                -- copies consistency properties from TuKrn to p_TuKrn.
%
%  Methods inherited from the superclass TuSol:
%
%  p_setAllSolutions  -- sets all solutions listed below to the class object TuSol.
%  p_setPreKernel     -- sets a pre-kernel element to the class object TuSol.
%  p_setPreNuc        -- sets the pre-nucleolus to the class object TuSol.
%  p_setShapley       -- sets the Shapley value to the class object TuSol.
%  p_setTauValue      -- sets the Tau value to the class object TuSol.
%  p_setBanzhaf       -- sets the Banzhaf value to the class object TuSol.
%  p_setAntiPreKernel -- sets an anti-kernel element to the class object TuSol.
%
...
%
    ...
    properties(GetAccess = 'public', SetAccess = 'private')
       ...
       methods
         function obj = p_TuKrn(w,gtype,gformat)
       % P_TUPRK creates the subclass object p_TuKrn to perform several computations for retrieving 
       % and modifying game data. It stores relevant game information and
       ...
       %
         ...
         function obj = p_setCplexKrn(obj,sol) 
         % P_SETCPLEXKRN sets a kernel element using CPLEX to the class object p_TuKrn.
         % 
         %  Usage: clv = p_setCplexKrn(clv,sol)
         %
         %  output:
         ...
         function obj = p_setCvxKrn(obj,sol) 
         % P_SETCVXKRN sets a kernel element using CVX to the class object p_TuKrn.
         % 
         %  Usage: clv = p_setCvxKrn(clv,sol)
         %
         %  output:
         %    clv       -- p_TuKrn class object.
         %
         ...
         function obj = p_setGurobiKrn(obj,sol) 
         % P_SETGUROBIKRN sets a kernel element using GUROBI to the class object p_TuKrn.
         % 
         ...
         function obj = p_setIpoptKrn(obj,sol) 
         % P_SETIPOPTKRN sets a kernel element using IPOPT to the class object p_TuKrn.
         % 
         ...
         function obj = p_setMskKrn(obj,sol) 
         % P_SETMSKKRN sets a kernel element using MOSEK to the class object p_TuKrn.
         % 
         ...
         function obj = p_setOasesKrn(obj,sol) 
         % SETOASESKRN sets a kernel element using OASES to the class object p_TuKrn.
         % 
         ...
         function obj = p_setQpcKrn(obj,sol) 
         % P_SETQPCKRN sets a kernel element using QPC to the class object p_TuKrn.
         % 
         ...
         function obj = p_setAllVendorKrn(obj)
         % P_SETALLVENDORKRN sets a set of kernel solutions to the class object p_TuKrn.
         %
        ...
        function obj = p_copyTuKrn(obj,clv)
        % copy constructor: class object clv to class object obj.
        %
        %  Usage: obj = p_copyTuKrn(obj,clv)
        %
        %  output:
        %    obj       -- p_TuKrn class object.
        %
