function [v,x]=p_grMaxFlowGame(E,s,t,n)
% P_GRMAXFLOWGAME computes from a flow problem (E,s,t,n) a TU flow game using Matlab's PCT.
...
%
% Usage: v=p_grMaxFlowGame(E,s,t,n)
%
% Define variables:
% output:
