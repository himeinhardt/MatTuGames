function ERGPQ=p_EC_DGP_Q(v,x,str,tol)
% P_ECRGPQ checks whether the solution x satisfies excess comparability for each derived game
% using Matlab's PCT.
%
...
%
%
% Usage: ERGPQ=p_EC_DGP_Q(v,x,str,tol) 
%
% Define variables:
%  output:
