function [x, Lerr, smat, xarr]=p_cplex_prekernel(v,x)
% P_CPLEX_PREKERNEL computes from (v,x) a pre-kernel element using cplexmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_cplex_prekernel(v,x)
%
% Define variables:
%  output:
