function [x, Lerr, smat, xarr]=p_msk_weightedKernel(v,pS,x)
% P_MSK_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using qpas.mex
% and Matlab's PCT.
% Source: Meinhardt, 2010.
%
% MSK-Solver: http://www.mosek.com/  
%
% Usage: [x Lerr smat xarr] = p_msk_weightedKernel(v,pS,x)
%
% Define variables:
%  output:
