function [v,x]=p_flow_game(E,c,ow)
% P_FLOW_GAME computes from a flow problem (E,c,ow) a TU flow game using the optimization toolbox, and
% Matlab's PCT.
% Uses Dual-Simplex (Matlab R2015a).
%
% Usage: v=p_flow_game(E,c,ow)
%
% Define variables:
% output:
