function [x, Lerr, smat, xarr]=cplex_weightedKernel(v,pS,x)
% CPLEX_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using cplexmex.
% Source: Meinhardt, 2010.
%
% http://www-01.ibm.com/software/websphere/ilog/
%
%
% Usage: [x Lerr smat xarr] = cplex_weightedKernel(v,pS,x)
%
% Define variables:
%  output:
