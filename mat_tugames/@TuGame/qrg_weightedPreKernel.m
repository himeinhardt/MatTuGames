function [x, Lerr, smat, xarr]=qrg_weightedPreKernel(clv,pS,x)
% QRG_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using qrginv.
% Source: Meinhardt, 2010.
%
%
% Usage: [x Lerr smat xarr]=qrg_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
