function [x, Lerr, smat, xarr]=cvx_weightedPreKernel(clv,pS,x)
% CVX_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using CVX.
...
%
% Usage: [x Lerr smat xarr] = cvx_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
