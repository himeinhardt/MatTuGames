function [x, Lerr, smat, xarr]=p_Anti_PModPreKernel(clv,x)
% P_ANTI_PMODPREKERNEL computes from (v,x) a proper modified anti-pre-kernel element using Matlab's PCT.
%
...
%
% Usage: [x Lerr smat xarr]=clv.p_Anti_PModPreKernel(x)
% Define variables:
%  output:
