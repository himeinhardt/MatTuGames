function [x, Lerr, smat, xarr]=ipopt_weightedPreKernel(clv,pS,x)
% IPOPT_WEIGHTEDPREKERNEL computes from (v,pS,x) a weigthed pre-kernel element 
...
%
%
% Usage: [x Lerr smat xarr]=ipopt_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
