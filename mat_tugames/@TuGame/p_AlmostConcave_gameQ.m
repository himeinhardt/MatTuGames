function [acvQ acvq]=p_AlmostConcave_gameQ(clv,tol)
% P_ALMOSTCONCAVE_GAMEQ returns 1 whenever the game v is almost concave using Matlab's PCT.
%
% Inspired by the
% Source: The bargaining set and the kernel for almost-convex games
%
% Usage: [acvQ acvq]=clv.p_AlmostConcave_gameQ(tol)
%
%
% Define variables:
%  output:
