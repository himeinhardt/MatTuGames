function [imp_vert,crst,ip_vol,P]=CddLowerSetSimplexVertices(clv)
% CDDLOWERSETVERTICES computes all vertices of the lower set of game v,
% whenever the lower set is non-empty. Projection method is simplex. 
...
%
% Usage: [imp_vert crst]=clv.CddLowerSetSimplexVertices()
% Define variables:
%  output:
