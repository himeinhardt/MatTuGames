function [x, Lerr, smat, xarr]=p_qrg_weightedPreKernel(clv,pS,x)
% P_QRG_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using qrginv, CXSparse
% and Matlab's PCT.
% 
...
%
%
% Usage: [x Lerr smat xarr]=p_qrg_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
