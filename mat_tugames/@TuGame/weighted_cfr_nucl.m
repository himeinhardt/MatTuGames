function [x1, fmin]=weighted_cfr_nucl(clv,F,pS,tol)
% CFR_NUCL computes the weighted nucleolus of game v with coalition formation restrictions 
...
%
% Usage: [x, fmin]=clv.weighted_cfr_nucl(F,pS,tol)
% Define variables:
%  output:
%  x1        -- The weighted nucleolus of game vF.
