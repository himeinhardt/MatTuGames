function SOL=tug_KernelImputationQ(clv,y)
% TUG verifies game solution/property with the Mathematica Package TuGames.
%
% Usage: SOL=tug_KernelImputationQ(v,y)
% Define variables:
%  output:
...
disp('Is Payoff a Kernel Element?...')
mkQ=math('kQ=KernelImputationListQ[ExpGame,rtx]');
x=math('math2matlab','rtx');
SOL=struct('Payoff',x,'MPayoff',py, 'MKernelQ',mkQ);
math('quit')
