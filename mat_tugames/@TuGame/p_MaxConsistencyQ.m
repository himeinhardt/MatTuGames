function [RGP RGPC]=p_MaxConsistencyQ(clv,x,str,tol)
% P_MAXCONSISTENCYQ checks whether an imputation x satisfies maximal
% consistency using Matlab's PCT.
%
% Usage: [RGP RGPC]=clv.p_MaxConsistencyQ(x,str,tol)
% Define variables:
%  output: Fields
...
elseif strcmp(str,'HMS_MODIC')
  vSa=clv.p_HMS_Reduced_game(x,'MODIC');
  vS=vSa{:,1};
  clear vSa;
else
