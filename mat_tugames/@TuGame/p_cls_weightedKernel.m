function [x, Lerr, smat, xarr]=p_cls_weightedKernel(clv,pS,x)
% P_CLS_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using a 
% least square solver of MOSEK and Matlab's PCT.
% Source: Meinhardt, 2010.
% 
% MSK-Solver: http://www.mosek.com/
%
% Usage: [x Lerr smat xarr]=p_cls_kernel(clv,pS,x)
%
% Define variables:
%  output:
...
% uncomment these values if you do not have Mosek.
    opts = optimset('LargeScale','on','TolFun',2.2204e-16,'TolPCG',0.2);
% opts=[]; 
