function [x, Lerr, smat, xarr]=cfr_Kernel(clv,F,x)
% CFR_KERNEL computes from (v,x) a Kernel element with coalition formation restrictions using
% Matlab's Optimization Toolbox.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr] = clv.cfr_Kernel(F,x)
%
% Define variables:
%  output:
