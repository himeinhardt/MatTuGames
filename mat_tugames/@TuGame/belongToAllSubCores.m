function bacQ=belongToAllSubCores(clv,x,tol)
% BELONGTOALLSUBCORES checks whether all projections of an imputation x are a member of 
% an associated core of a subgame.
%
%
% Usage: bacQ=clv.belongToAllSubCores(x,tol)
%
