function [x1,fmin]=cplex_AntiPreNucl_mod4(clv,tol)
% CPLEX_ANTIPRENUCL_MOD4 computes the anti pre-nucleolus of game v using cplexmex.
%
% http://www-01.ibm.com/software/websphere/ilog/
% (compatible with CPLEX Version 12.10.0 and higher)
% 
%
% Usage: [x, alp]=clv.cplex_AntiPreNucl_mod4(tol)
% Define variables:
%  output:
