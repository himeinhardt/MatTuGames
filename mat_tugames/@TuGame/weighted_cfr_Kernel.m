function [x, Lerr, smat, xarr]=weighted_cfr_Kernel(clv,F,pS,x)
% WEIGHTED_CFR_KERNEL computes from (v,x) a weighted Kernel element with coalition formation restrictions using
% Matlab's Optimization Toolbox.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr] = clv.weighted_cfr_Kernel(F,pS,x)
%
% Define variables:
%  output:
%  x        -- Weighted kernel element (output) w.r.t. vF,
