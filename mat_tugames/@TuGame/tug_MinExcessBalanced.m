function SOL=tug_MinExcessBalanced(clv,y)
% TUG verifies game solution/property with the Mathematica Package TuGames.
%
% Usage: SOL=tug_MinExcessBalanced(v,y)
% Define variables:
%  output:
%  SOL        -- Returns 'True' or 'False' in Mathematica output format whenever the minimum surpluses are balanced.
...
mb1=math('mb01=MinExcessBalanced[ExpGame,rtx]');
SOL=struct('MinExcessBalancedQ',mb1);
math('quit')
