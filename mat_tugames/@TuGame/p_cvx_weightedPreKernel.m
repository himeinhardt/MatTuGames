function [x, Lerr, smat, xarr]=p_cvx_weightedPreKernel(clv,pS,x)
% P_CVX_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using CVX
% and Matlab's PCT.
...
%
% Usage: [x Lerr smat xarr] = p_cvx_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
