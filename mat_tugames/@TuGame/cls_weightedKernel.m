function [x, Lerr, smat, xarr]=cls_weightedKernel(clv,pS,x)
% CLS_WEIGHTEDKERNEL computes from (v,x) a weighted kernel element.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr]=cls_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
