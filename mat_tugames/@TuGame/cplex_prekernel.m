function [x, Lerr, smat, xarr]=cplex_prekernel(clv,x)
% CPLEX_PREKERNEL computes from (clv,x) a pre-kernel element using cplexmex.
% Source: Meinhardt, 2010.
%
% CPLEX-Solver: http://www-01.ibm.com/software/websphere/ilog/
%
%
% Usage: [x Lerr smat xarr] = cplex_prekernel(clv,x)
%
% Define variables:
%  output:
