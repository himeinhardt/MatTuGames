function [x, Lerr, smat, xarr]=Anti_ModPreKernel2(clv,x)
%ANTI_MODPREKERNEL computes from (v,x) a modified anti-pre-kernel element.
%
%  Inspired by P. Sudh¨olter. Nonlinear Self Dual Solutions for TU-Games. In Potters J.A.M. Raghavan T.E.S. Ray D. Sen A.
...
%
% Usage: [x Lerr smat xarr]=clv.Anti_ModPreKernel(x)
%
% Define variables:
%  output:
...
x=x';
[x, Lerr, smat, xarr]=computeAntiPrk(v_x,x,smc,0,mnQ);
