function [cQ,wpn_v,nwex,wexQ]=WSysPreNuclQ(clv,pS,tol)
% WSYSPRENUCLQ checks the correctness of the pre-nucleolus of a weight system pS.
...
% Define variables:
%  output:
%  cQ       -- Returns true (1) whenever the weighted pre-nucleolus w.r.t.
%              the Tu-game v and a weight system pS was correctly evaluated, 
%              otherwise false (0).
%  wpn_v    -- Returns the weighted pre-nucleolus w.r.t. v and pS
%  nwex     -- Returns the pre-nucleolus of the excess game wex. 
