function [x, Lerr, smat, xarr]=p_ipopt_weightedKernel(clv,pS,x)
% P_IPOPT_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element 
% using least squares method (ipoptmex) and Matlab's 
% PCT.
...
%
%
% Usage: [x Lerr smat xarr]=p_ipopt_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
