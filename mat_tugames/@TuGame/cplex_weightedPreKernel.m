function [x, Lerr, smat, xarr]=cplex_weightedPreKernel(clv,pS,x)
% CPLEX_WEIGHTEDPREKERNEL computes from (clv,pS,x) a weighted pre-kernel element using cplexmex.
% Source: Meinhardt, 2010.
%
% CPLEX-Solver: http://www-01.ibm.com/software/websphere/ilog/
%
%
% Usage: [x Lerr smat xarr] = cplex_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
