function [x, Lerr, smat, xarr]=cplex_weightedKernel(clv,pS,x)
% CPLEX_WEIGHTEDKERNEL computes from (v,pS,x) a weighted ernel element using cplexmex.
% Source: Meinhardt, 2010.
%
% http://www-01.ibm.com/software/websphere/ilog/
%
%
% Usage: [x Lerr smat xarr] = cplex_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
