function [x, Lerr, smat, xarr]=clp_weightedKernel(clv,pS,x)
% CLP_WEIGHTEDKERNEL computes from (v,x) a weighted kernel element using mexclp.
% Source: Meinhardt, 2010.
%
% CLP-Solver: https://projects.coin-or.org/Clp 
%
% Usage: [x Lerr smat xarr] = clp_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
