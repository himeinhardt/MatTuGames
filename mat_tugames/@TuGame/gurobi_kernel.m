function [x, Lerr, smat, xarr]=gurobi_kernel(clv,x)
% GUROPI_KERNEL computes from (v,x) a kernel element using gurobimex.
% Source: Meinhardt, 2010.
%
% GUROPI-SOLVER: http://www.gurobi.com
%
%
% Usage: [x Lerr smat xarr] = gurobi_kernel(clv,x)
%
% Define variables:
%  output:
