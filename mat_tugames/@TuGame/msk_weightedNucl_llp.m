function [x1, alp]=msk_weightedNucl_llp(clv,pS,tol)
% MSK_WEIGHTEDNUCL_LLP computes a weighted nucleolus of game v using mosekmex.
% 
% MSK-SOLVER: http://www.mosek.com/
%
% Usage: [x, alp]=msk_weightedNucl_lpp(clv,pS,tol)
% Define variables:
%  output:
