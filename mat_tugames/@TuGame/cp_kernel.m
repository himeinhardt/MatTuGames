function [x, Lerr, smat, xarr]=cp_kernel(clv,x)
% CP_KERNEL computes from (clv,x) a Kernel element using the cone programming solver of
...
%
%
% Usage: [x Lerr smat xarr] = clv.cp_kernel(x)
%
% Define variables:
%  output:
...
%% Conic Optimization
%% Setting Options
% opts = optimoptions("coneprog","OptimalityTolerance",1e-8,"ConstraintTolerance",1e-8,"LinearSolver","auto","Display","off");
opts = optimoptions("coneprog",'Display','iter',"OptimalityTolerance",1e-12,"ConstraintTolerance",1e-12,"LinearSolver","normal","Display","off");
...
%% checking kernel property
    ...
    Q=E'*E; % symmetric positive semi-definite matrix.
    b=-E'*a;
%
