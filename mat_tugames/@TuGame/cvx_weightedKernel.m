function [x, Lerr, smat, xarr]=cvx_weightedKernel(clv,pS,x)
% CVX_WEIGHTEDKERNEL computes from (v,x) a weighted kernel element using CVX.
...
%
% Usage: [x Lerr smat xarr] = cvx_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
