function RG=p_LED_RGPvsDGP(clv,x,tol)
% P_LED_RGPvsDGP determines the shift of reduced games of the ECC game or reduced game of the dual cover 
...
%
%
% Usage: RG=clv.p_LED_RGPvsDGP(x,tol) 
%
% Define variables:
%
%  Output Fields
...
MMEX=clv.MMExcess(mnc_v);
dc_v=clv.p_DualCover();
t=MMEX.mev + MMEX.medv;
[RGP RGPC]=p_Reduced_game_propertyQ(dc_v,[mnc_v,mnc_v],'PRN');
[DGP_mnc_v DGPC_mnc_v]=clv.p_Derived_game_propertyQ(mnc_v,'MODIC');
[LEDC_mnc_v LEDCGPQ_mnc_v]=clv.p_Ledcons_propertyQ(mnc_v,'MODIC');
