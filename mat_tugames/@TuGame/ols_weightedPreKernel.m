function [x, Lerr, smat, xarr]=ols_weightedPreKernel(clv,pS,x)
%OLS_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr]=ols_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
