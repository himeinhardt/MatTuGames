function [cQ,wpk_v,wpkQ,pkQ_wex]=WSysPreKernelQ(clv,pS,x,tol)
...
%
% Usage: [cQ,wpn_v,nwex,wexQ]=clv.WSysPreKernelQ(pS,tol) 
%
% Define variables:
%  output:
...
if isempty(x)
  wpk_v=clv.weightedPreKernel(pS);
else
  wpk_v=x;
end

wpkQ=clv.weightedPrekernelQ(wpk_v,pS);
