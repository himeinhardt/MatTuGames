function v_t=p_HMS_AntiReduced_game(clv,x,str)
% P_HMS_ATNIREDUCED_GAME computes from (v,x) all Hart/Mas-Colell anti-reduced 
...
%
% Usage: v_t=clv.p_HMS_AntiReduced_game(x,str)
%
% Define variables:
%  output:
...
parfor S=1:N-1
  [v1_t{1,S} v2_t{1,S} v3_t{1,S}]=hms_AntiRed_game(v,S,n,str);
end
