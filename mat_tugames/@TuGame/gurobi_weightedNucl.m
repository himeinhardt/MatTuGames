function [x1, alp]=gurobi_weightedNucl(clv,pS,tol)
% GUROBI_WEIGHTEDNUCL computes a weighted pre-nucleolus of game v using gurobimex.
% 
% GUROPI-SOLVER: http://www.gurobi.com
%
% Usage: [x, alp]=gurobi_weightedNucl(clv,pS,tol)
% Define variables:
%  output:
