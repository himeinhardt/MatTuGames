function [x1, fmin]=PreNucl_mod2(clv,tol)
% PRENUCL_MOD2 computes the pre-nucleolus of game v using the optimization toolbox.
% Uses now Dual-Simplex (Matlab R2015a).
%
% Requires: pagemtimes 
% 
%
% Usage: [x, alp]=clv.PreNucl_mod2(tol)
% Define variables:
%  output:
