function [bcQ, cmat, S]=weightedB0_balancedCollectionQ(clv,x,pS,tol)
% WEIGHTEDB0_BALANCEDCOLLECTIONQ verifies whether the set of induced
...
% 
%
% Usage: bcQ=clv.weightedB0_balancedCollectionQ(x,tol)
% Define variables:
%  output:
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [cmat,sol,ef]=CheckB0Bal(n,iS)
