function [bcQ, cmat, S]=B0_balancedCollectionQ(clv,x,tol)
% B=_BALANCEDCOLLECTIONQ verifies whether the set of induced
...
% 
%
% Usage: bcQ=clv_B0_balancedCollectionQ(x,tol)
% Define variables:
%  output:
