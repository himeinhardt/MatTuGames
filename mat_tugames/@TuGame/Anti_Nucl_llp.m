function [x1, fmin]=Anti_Nucl_llp(clv,tol)
% ANTI_NUCL_LLP computes the anti nucleolus of game v using the optimization toolbox.
% Uses now Dual-Simplex (Matlab R2015a).
%
% Usage: [x, fmin]=clv.AntiNucl_llp(tol)
% Define variables:
%  output:
