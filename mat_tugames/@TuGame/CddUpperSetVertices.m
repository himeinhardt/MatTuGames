function [imp_vert,crst,ip_vol,P]=CddUpperSetVertices(clv,idx)
% CDDUPPERSETVERTICES computes all vertices of the upper set of game v, 
% whenever the upper set is non-empty. The cdd-library by 
...
%
% Usage: [imp_vert crst]=clv.CddUpperSetVertices()
% Define variables:
%  output:
