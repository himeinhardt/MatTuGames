function [x, Lerr, smat, xarr]=p_oases_weightedPreKernel(clv,pS,x)
% P_WEIGHTEDOASES_PREKERNEL computes from (v,pS,x) a weighted pre-kernel element using qpOASESmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_oases_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
