function [x, Lerr, smat, xarr]=p_oases_kernel(clv,x)
% P_OASES_KERNEL computes from (v,x) a Kernel element using qpOASESmex
...
%  
%
% Usage: [x Lerr smat xarr] = p_oases_kernel(clv,x)
%
% Define variables:
%  output:
