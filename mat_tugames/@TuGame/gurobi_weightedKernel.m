function [x, Lerr, smat, xarr]=gurobi_weightedKernel(clv,pS,x)
% GUROPI_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using gurobimex.
% Source: Meinhardt, 2010.
%
% GUROPI-SOLVER: http://www.gurobi.com
%
%
% Usage: [x Lerr smat xarr] = gurobi_weightdKernel(clv,pS,x)
%
% Define variables:
%  output:
