function [x, Lerr, smat, xarr]=qpc_prekernel(clv,x)
% QPC_PREKERNEL computes from (v,x) a pre-kernel element using qpas.mex.
% Source: Meinhardt, 2010.
%
% QPC-Solver: http://sigpromu.org/quadprog/index.html 
%
% Usage: [x Lerr smat xarr] = qpc_prekernel(clv,x)
%
% Define variables:
%  output:
