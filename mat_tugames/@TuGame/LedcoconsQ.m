function [COLED COLEDC]=LedcoconsQ(clv,x,str,tol)
% LEDCOCONSQ checks whether an imputation x satisfies large excess difference converse 
...
%
% Usage [COLED COLEDC]=clv.LedcoconsQ(x,str,tol)
%
% Define variables:
%
%  output: Fields
