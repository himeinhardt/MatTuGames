function ABd=p_GetAll_Borel_dividends(clv,idxfm,method,tol)
% P_GETAll_BOREL_DIVIDENDS computes all possible arrays of Borel dividends from an index function matrix
% using MATLAB's PCT.
% For n>14 this function needs some time to complete.
%
% Usage: ABd=clv.p_GetAll_Borel_dividends(idxfm,method)
