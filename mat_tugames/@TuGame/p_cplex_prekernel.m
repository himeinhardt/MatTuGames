function [x, Lerr, smat, xarr]=p_cplex_prekernel(clv,x)
% P_CPLEX_PREKERNEL computes from (clv,x) a pre-kernel element using cplexmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_cplex_prekernel(clv,x)
%
% Define variables:
%  output:
