function [vm ext_v]=p_DualFloor(clv)
% P_DUALFLOOR determines smallest amount of the combined influence of
% the exercised and preventive power of a pair of coalitions using Matlab's PCT.
%
