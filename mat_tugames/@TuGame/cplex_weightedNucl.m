function [x1, fmin]=cplex_weightedNucl(clv,pS,tol)
% CPLEX_WEIGHTEDNUCL computes the pre-nucleolus of game v using glpkmex.
% 
% http://www-01.ibm.com/software/websphere/ilog/
% (compatible with CPLEX Version 12.10.0 and higher)
%
%
% Usage: [x, alp]=cplex_weightedNucl(clv,pS,tol)
% Define variables:
%  output:
