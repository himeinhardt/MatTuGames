function bcQ=p_AntiB0_balancedCollectionQ(clv,x,tol)
% P_AntiB0_BALANCEDCOLLECTIONQ verifies whether the set of induced
...
%
%
% Usage: bcQ=clv.p_AntiB0_balancedCollectionQ(x,tol)
% Define variables:
%  output:
...
for kk=1:leb;
    F(kk) = parfeval(p,@p_AntiBalancedSetQ,1,exc,n,cS{kk},tol);
end
