function [x, Lerr, smat, xarr]=weightedKernel(clv,pS,x)
% WEIGHTEDKERNEL computes from (v,x) a weighted kernel element using
% Matlab's Optimization Toolbox.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr] = weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
