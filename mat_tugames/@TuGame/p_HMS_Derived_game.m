function v_t=p_HMS_Derived_game(clv,x,str)
% P_HMS_DERIVED_GAME computes from (v,x,S) a modified Hart-Mas-Colell reduced game vS on S at x for
...
%
% Usage: vt=clv.p_HMS_Derived_game(x)
%
% Define variables:
%
%  output:
...
vSa=clv.p_HMS_Reduced_game(x,str);
vS=vSa{:,1};
clear vSa;
dvSa=p_HMS_Reduced_game(dv,x,str);
dvS=dvSa{:,1};
clear dvSa;
