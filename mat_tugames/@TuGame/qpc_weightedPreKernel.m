function [x, Lerr, smat, xarr]=qpc_weightedPreKernel(clv,pS,x)
% QPC_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using qpas.mex.
% Source: Meinhardt, 2010.
%
% QPC-Solver: http://sigpromu.org/quadprog/index.html 
%
% Usage: [x Lerr smat xarr] = qpc_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
