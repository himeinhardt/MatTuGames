function [bcQ,cmat,S]=cfr_balancedCollectionQ(clv,x,F,tol)
% CFR_BALANCEDCOLLECTIONQ verifies whether the set of induced
% coalitions is a balanced collection  with coalition formation restriction. 
...
% 
%
% Usage: bcQ=clv.cfr_balancedCollectionQ(x,F,tol)
% Define variables:
%  output:
