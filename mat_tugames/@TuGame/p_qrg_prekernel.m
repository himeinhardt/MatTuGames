function [x, Lerr, smat, xarr]=p_qrg_prekernel(clv,x)
% P_QRG_PREKERNEL computes from (v,x) a pre-kernel element using qrginv
% and Matlab's PCT.
% Source: Meinhardt, 2010.
%
%
% Usage: [x Lerr smat xarr]=p_qrg_prekernel(clv,x)
%
% Define variables:
%  output:
