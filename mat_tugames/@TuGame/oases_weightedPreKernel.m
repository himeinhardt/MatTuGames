function [x, Lerr, smat, xarr]=oases_weightedPreKernel(clv,pS,x)
% OASES_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using qpOASESmex.
% Source: Meinhardt, 2010.
%
%  http://www.kuleuven.be/optec/software/qpOASES
%
%
% Usage: [x Lerr smat xarr] = oases_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
