function [x, Lerr, smat, xarr]=ipopt_weightedKernel(clv,pS,x)
% IPOPT_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element 
% using least squares method (ipoptmex).
...
%
%
% Usage: [x Lerr smat xarr]=ipopt_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
