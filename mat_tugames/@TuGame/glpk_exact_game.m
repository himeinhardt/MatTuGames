function [v_e xm exfl]=glpk_exact_game(clv,tol);
% GLPK_EXACT_GAME computes the exact game from game v using glpkmex.
%
% http://www.gnu.org/software/glpk/glpk.html 
%
%  Usage: [v_e xm status]=clv.glpk_exact_game(tol);
%
% Define variables:
%  output:
