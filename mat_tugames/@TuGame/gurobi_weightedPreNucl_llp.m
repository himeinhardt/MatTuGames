function [x1, alp]=gurobi_weightedPreNucl_llp(clv,pS,tol)
% GUROBI_WEIGHTEDPRENUCL_LLP computes a weighted pre-nucleolus of game v using gurobimex.
% 
% GUROPI-SOLVER: http://www.gurobi.com
%
% Usage: [x, alp]=gurobi_weightedPreNucl_llp(v,pS,tol)
% Define variables:
%  output:
