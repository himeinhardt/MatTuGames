function [prkQ, smat]=PModPrekernelQ(clv,x,tol)
% PMODPREKERNELQ checks whether the imputation x is a proper modified pre-kernel element 
% of the TU-game v.
% 
%  Usage:[prkQ smat e]=clv.PModPrekernelQ(x,tol);
%
%
% Define variables:
%  output:
