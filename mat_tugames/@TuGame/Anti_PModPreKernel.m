function [x, Lerr, smat, xarr]=Anti_PModPreKernel(clv,x)
%ANTI_PMODPREKERNEL computes from (v,x) a proper modified anti-pre-kernel element.
%
%
...
%
% Usage: [x Lerr smat xarr]=clv.Anti_PModPreKernel(x)
%
% Define variables:
%  output:
