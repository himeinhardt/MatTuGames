function [apnlp,apdpQ]=p_AP_NullPlayers(clv,tol)
% P_AP_NullPlayers returns the players who are AP-Null players using Matlab's PCT.
%
% Usage: apdpQ=clv.p_AP_NullPlayers(tol)
% Define variables:
%  output:
