function [x, Lerr, smat, xarr]=p_ipopt_weightedPreKernel(clv,pS,x)
% P_IPOPT_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element 
% using least squares method (ipoptmex) and Matlab's PCT.
% Source: Meinhardt, 2010.
%
% https://projects.coin-or.org/Ipopt
%
%
% Usage: [x Lerr smat xarr]=p_ipopt_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
