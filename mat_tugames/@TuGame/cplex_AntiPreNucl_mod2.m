function [x1, fmin]=cplex_AntiPreNucl_mod2(clv,tol)
% CPLEX_ANTIPRENUCL_MOD2 computes the anti pre-nucleolus of game v using cplexmex.
%
...
% 
%
% Usage: [x, alp]=clv.cplex_AntiPreNucl_mod2(tol)
% Define variables:
%  output:
...
opts.RECT = true;
opts.TRANSA = false;
%% Adjust the number of threads on your system. 
