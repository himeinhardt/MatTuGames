function [x, Lerr, smat, xarr]=qpBB_kernel(clv,x)
% QBBB_KERNEL computes from (v,x) a Kernel element is using quadprogBBmex.
% Source: Meinhardt, 2010.
%
% http://dollar.biz.uiowa.edu/~sburer/pmwiki/pmwiki.php
%
%
% Usage: [x Lerr smat xarr] = qpBB_kernel(clv,x)
%
% Define variables:
%  output:
