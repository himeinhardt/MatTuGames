function [x, Lerr, smat, xarr]=p_ols_weightedPreKernel(clv,pS,x)
% P_OLS_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using Matlab's PCT.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr]=p_ols_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
