function [x1, fmin]=glpk_weightedNucl_llp(clv,pS,tol)
% GLPK_WEIGHTEDNUCL_LLP computes a weighted nucleolus of game v using glpkmex.
% 
% http://www.gnu.org/software/glpk/glpk.html
%
%
% Usage: [x, alp]=glpk_weightedNucl_llp(clv,pS,tol)
% Define variables:
%  output:
