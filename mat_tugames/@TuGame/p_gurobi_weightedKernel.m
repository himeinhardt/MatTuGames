function [x, Lerr, smat, xarr]=p_gurobi_weightedKernel(clv,pS,x)
% P_GUROPI_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using gurobimex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_gurobi_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
