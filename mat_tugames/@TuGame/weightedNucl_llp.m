function [x1, fmin]=weightedNucl_llp(clv,pS,tol)
% WEIGHTEDNUCL_LLP computes a weighted nucleolus of game v using the optimization toolbox.
% Uses now Dual-Simplex (Matlab R2015a).
%
% Usage: [x, fmin]=weightedNucl_llp(clv,pS,tol)
% Define variables:
%  output:
