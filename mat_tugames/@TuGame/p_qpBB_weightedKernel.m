function [x, Lerr, smat, xarr]=p_qpBB_weightedKernel(clv,pS,x)
% P_QBBB_WEIGHTEDKERNEL computes from (v,pS,x) a weightred kernel element is using quadprogBBmex
% and Matlab's PCT.
% Source: Meinhardt, 2010.
%
%  http://dollar.biz.uiowa.edu/~sburer/pmwiki/pmwiki.php
%
% Usage: [x Lerr smat xarr] = p_qpBB_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
...
%  smat     -- Matrix of maximum weighed surpluses.
