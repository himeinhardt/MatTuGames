function [x, Lerr, smat, xarr]=p_cplex_kernel(clv,x)
% P_CPLEX_KERNEL computes from (v,x) a Kernel element using cplexmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_cplex_kernel(clv,x)
%
% Define variables:
%  output:
