function [x, Lerr, smat, xarr]=glpk_weightedPreKernel(clv,pS,x)
% GLPK_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using glpkmex.
% Source: Meinhardt, 2010.
%
% http://www.gnu.org/software/glpk/glpk.html
%
%
% Usage: [x Lerr smat xarr] = glpk_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
