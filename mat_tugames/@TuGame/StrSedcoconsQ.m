function [SCOSED SCOSEDC]=StrSedcoconsQ(clv,x,str,tol)
...
%
% Usage: [SCOSED SCOSEDC]=clv.StrSedcoconsQ(x,str,tol)
%
% Define variables:
%
%  output: Fields
...
if strcmp(str,'MAPRK')
  sV_sol{1,N}=clv.Anti_ModPreKernel(x);
elseif strcmp(str,'PMAPRK')
  sV_sol{1,N}=clv.Anti_PModPreKernel(x);
elseif strcmp(str,'MODIC')
  try
...
elseif strcmp(str,'APRK')
  sV_sol{1,N}=clv.Anti_PreKernel(x);
elseif strcmp(str,'APRN')
  try
