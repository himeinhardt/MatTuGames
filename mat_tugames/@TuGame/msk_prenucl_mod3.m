function [x1,fmin]=msk_prenucl_mod3(clv,tol)
% function [x1, bA,fmin]=msk_prenucl_mod3(v,tol)
% MSK_PRENUCL_MOD3 computes the pre-nucleolus of game v using mosekmex.
%
% MSK-SOLVER: http://www.mosek.com/
% 
%
% Usage: [x, fmin]=clv.msk_prenucl_mod3(tol)
% Define variables:
%  output:
