function cs_vl=CoalitionSolidarity(clv,cs)
% CoalitionSolidarity computes a coalitional solidarity value w.r.t. 
% the coalition structure cs.    
%
% Usage: cs_vl=CoalitionSolidarity(clv,cs)
%
% Define variables:
%  output:
