function [x, Lerr, smat, xarr]=p_weightedKernel(clv,pS,x)
% P_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using
% Matlab's Optimization Toolbox and Matlab's PCT.
% Source: Meinhardt, 2014.
%
% Usage: [x Lerr smat xarr] = p_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
