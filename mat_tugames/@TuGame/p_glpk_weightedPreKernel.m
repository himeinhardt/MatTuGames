function [x, Lerr, smat, xarr]=p_glpk_weightedPreKernel(clv,pS,x)
% P_GLPK_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using glpkmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_glpk_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
