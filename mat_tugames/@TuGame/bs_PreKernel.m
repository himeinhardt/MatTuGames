function [x, Lerr, smat, xarr]=bs_PreKernel(clv,x)
%BS_PREKERNEL computes from (v,x) a pre-kernel element from the dual cover of v 
% while using MATLAB's backslash operation. 
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr]=clv.dc_PreKernel(x)
%
% Define variables:
%  output:
