function [acvQ Smarg sumMg]=p_average_concaveQ(clv,tol)
% P_AVERAGE_CONVEXQ returns 1 whenever the game v is average-concave
% using Matlab's PCT.
%
% Usage: [acvQ Smarg sumMg]=clv.p_average_concaveQ(tol)
% Define variables:
%  output:
%  acvQ     -- Returns 1 (true) or 0 (false).
%  Smarg    -- Returns the list of super-sets which have a negative
%              sum of marginal contributions (1) or a positive (0).
