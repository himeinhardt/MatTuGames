function asd_vl=p_apu_SolidarityValue(clv,cs)
% P_APU_SOLIDARITYVALUE computes the solidarity value w.r.t. 
% the coalition structure cs (a prioir unions) using Matlab's PCT.    
%
% Usage: asd_vl=p_apu_SolidarityValue(clv,cs)
%
% Define variables:
%  output:
%  sh_cs    -- The solidarity value for coalition structure cs
%              (a priori unions)
%
%  input:
