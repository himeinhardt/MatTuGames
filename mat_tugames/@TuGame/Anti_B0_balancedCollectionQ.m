function [bcQ, cmat, S]=Anti_B0_balancedCollectionQ(clv,x,tol)
% ANTI_B0_BALANCEDCOLLECTIONQ verifies whether the set of induced
% coalitions is a anti B0_balanced collection. Checking Kohlberg's criterion.
% Requires Matlab's Optimization toolbox (default), otherwise CPLEX.
% Uses now Dual-Simplex (Matlab R2015a).
% 
%
% Usage: bcQ=clv.Anti_B0_balancedCollectionQ(x,tol)
% Define variables:
%  output:
...
% CHECKAntiB0BAL checks B0-balancedness of the collection iS.
%
%
% Define variables:
%  output:
