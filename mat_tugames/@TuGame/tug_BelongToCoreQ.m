function SOL=tug_BelongToCoreQ(clv,y)
% TUG_BELONGTOCOREQ verifies if the imputation set belongs to the core. It calls the Mathematica Package TuGames.
...
%    
% Usage: SOL=tug_BelongToCoreQ(v,y) 
% Define variables:
%  output:
...
crQ=math('BelongToCoreQ[ExpGame,rtx]');
