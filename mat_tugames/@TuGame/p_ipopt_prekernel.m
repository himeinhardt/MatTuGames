function [x, Lerr, smat, xarr]=p_ipopt_prekernel(clv,x)
% P_IPOPT_PREKERNEL computes from (v,x) a pre-kernel element 
...
%
%
% Usage: [x Lerr smat xarr]=p_ipopt_prekernel(clv,x)
%
% Define variables:
%  output:
