function [x, Lerr, smat, xarr]=p_hsl_weightedPreKernel(clv,pS,x)
% P_HSL_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using HSL's MA57/MA86/MA87
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr]=p_hsl_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
