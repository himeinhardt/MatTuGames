function [x, Lerr, smat, xarr]=p_cplex_weightedKernel(clv,pS,x)
% P_CPLEX_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using cplexmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_cplex_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
