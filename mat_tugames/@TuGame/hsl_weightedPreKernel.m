function [x, Lerr, smat, xarr]=hsl_weightedPreKernel(clv,pS,x)
% HSL_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using HSL's MA57/MA86/MA87.
...
%
%
% Usage: [x Lerr smat xarr]=hsl_weightedPreKernel(clv,pS,x)
%
% Define variables:
%  output:
