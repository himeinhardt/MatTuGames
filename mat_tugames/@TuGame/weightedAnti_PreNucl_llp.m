function [x1, fmin]=weightedAnti_PreNucl_llp(clv,pS,tol)
% WEIGHTED_PRENUCL_LLP computes a weighted anti pre-nucleolus of game v using the optimization toolbox.
% Uses now Dual-Simplex (Matlab R2015a).
%
% Usage: [x, fmin]=clv.weightedAnti_PreNucl_llp(pS,tol)
% Define variables:
%  output:
