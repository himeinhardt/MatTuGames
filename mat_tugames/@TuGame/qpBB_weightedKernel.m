function [x, Lerr, smat, xarr]=qpBB_weightedKernel(clv,pS,x)
% QBBB_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element is using quadprogBBmex.
% Source: Meinhardt, 2010.
%
% http://dollar.biz.uiowa.edu/~sburer/pmwiki/pmwiki.php
%
%
% Usage: [x Lerr smat xarr] = qpBB_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
