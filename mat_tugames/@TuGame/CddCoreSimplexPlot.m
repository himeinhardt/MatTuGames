function CddCoreSimplexPlot(varargin)
% CDDWCORESIMPLEXPLOT plots the dual core of game v. 
%
% Requires the Multi-Parametric Toolbox 3
% http://people.ee.ethz.ch/~mpt/3/
%
% Usage: CddCoreSimplexPlot(varargin)
% Define variables:
%  output:
%             -- A simplex plot of a Core of game v.
%
...
%                Core set, otherwise it is ommitted.
...
%                Then invoke
%
%                CddCoreSimplexPlot(v,'all',vw_pt)
%
