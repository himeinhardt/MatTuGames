function [x1, fmin]=cplex_weightedPreNucl_llp(clv,pS,tol)
% CPLEX_WEIGHTEDPRENUCL_LLP computes a weighted pre-nucleolus of game v using cplexmex.
%
% http://www-01.ibm.com/software/websphere/ilog/
% (compatible with CPLEX Version 12.10.0 and higher)
% 
%
% Usage: [x, alp]=clv.cplex_weightedPreNucl_llp(pS,tol)
% Define variables:
%  output:
