function SOL=tug_UpperSetQ(clv)
% TUG_UPPERSETQ verifies if the upper set is non-empty. It calls the Mathematica Package TuGames.
...
crQ=math('UpperSetQ[ExpGame]');
SOL=struct('UpperSetQ',crQ);
math('quit')
