function ow_vl=BanzhafOwenValue(clv,cs)
% BANZHAFOWEN_VALUE computes the Banzhaf-Owen value w.r.t. 
% a priori unions cs.
%
% Usage: ow_vl=clv.BanzhafOwenValue(cs)
%
% Define variables:
%  output:
...
cw=cw(pcl2);
sh_cw=banzhaf(cw); % normalized to one.
ow_vl=zeros(1,n);
J=1:n;
int=0:-1:1-n;
