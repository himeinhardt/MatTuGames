function [x, Lerr, smat, xarr]=p_gurobi_kernel(clv,x)
% P_GUROPI_KERNEL computes from (v,x) a kernel element using gurobimex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_gurobi_kernel(clv,x)
%
% Define variables:
%  output:
