function [x, Lerr, smat, xarr]=p_lin_prekernel(clv,x)
% P_LIN_PREKERNEL computes from (v,x) a pre-kernel element using Matlab's linsolve
% and Matlab's PCT.
% Source: Meinhardt, 2010.
%
%
% Usage: [x Lerr smat xarr]=p_lin_prekernel(clv,x)
%
% Define variables:
%  output:
