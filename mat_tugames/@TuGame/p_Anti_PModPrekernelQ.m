function [aprkQ smat e]=p_Anti_PModPrekernelQ(clv,x,tol)
% P_ANTI_PMODPREKERNELQ checks whether the imputation x is a proper modified anti-pre-kernel element 
% of the TU-game v. It uses Matlab's PCT.
% 
%  Usage: [prkQ smat e]=clv.p_Anti_PModPrekernelQ(x,tol);
%
%
% Define variables:
%  output:
