function [x, Lerr, smat, xarr]=p_glpk_prekernel(clv,x)
% P_GLPK_PREKERNEL computes from (v,x) a pre-kernel element using glpkmex
% and Matlab's PCT.
...
%
%
% Usage: [x Lerr smat xarr] = p_glpk_prekernel(clv,x)
%
% Define variables:
%  output:
