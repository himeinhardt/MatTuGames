function SOL=tug_MaxExcessBalanced(clv,y)
% TUG verifies game solution/property with the Mathematica Package TuGames.
%
% Usage: SOL=tug_MaxExcessBalanced(v,y)
% Define variables:
%  output:
%  SOL        -- Returns 'True' or 'False' in Mathematica output format whenever the maximum surpluses are balanced.
...
mb1=math('mb01=MaxExcessBalanced[ExpGame,rtx]');
SOL=struct('MaxExcessBalancedQ',mb1);
math('quit')
