function DPPQ=p_DummyPlayer_propertyQ(clv,x,tol)
% DUMMYPLAYER_PROPERTYQ verifies if x satisfies the dummy player property 
% using Matlab's PCT.
%
%  Usage: DPPQ=clv.p_DummyPlayer_propertyQ(x,tol)
%
% Define variables:
%  output: Fields
