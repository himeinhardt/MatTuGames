function [x, Lerr, smat, xarr]=msk_weightedKernel(clv,pS,x)
% MSK_WEIGHTDKERNEL computes from (v,pS,x) a weighted kernel element using mosekmex.
% Source: Meinhardt, 2010.
%
% MSK-Solver: http://www.mosek.com/  
%
% Usage: [x Lerr smat xarr] = msk_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
