function SOL=tug_SetsToVec(clv,y)
% TUG verifies game solution/property with the Mathematica Package TuGames.
%
% Usage: SOL=tug_SetsToVec(v,y)
% Define variables:
%  output:
%  SOl        -- Returns the set of most effective coalitions in a set of vectors.
...
stv1=math('stv=SetsToVec[bsc01,T,EffVector->True]');
mstv=math('math2matlab','stv');
SOL=struct('MatrixE',mstv,'BestCoalitions',bsc1);
math('quit')
