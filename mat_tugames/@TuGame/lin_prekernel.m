function [x, Lerr, smat, xarr]=lin_prekernel(clv,x)
% LIN_PREKERNEL computes from (v,x) a pre-kernel element using Matlab's linsolve.
% Source: Meinhardt, 2010.
%
%
% Usage: [x Lerr smat xarr]=lin_prekernel(clv,x)
%
% Define variables:
%  output:
