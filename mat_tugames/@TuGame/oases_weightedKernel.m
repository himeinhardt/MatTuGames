function [x, Lerr, smat, xarr]=oases_weightedKernel(clv,pS,x)
% OASES_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using qpOASESmex.
% Source: Meinhardt, 2010.
%
%  http://www.kuleuven.be/optec/software/qpOASES
%  
%
% Usage: [x Lerr smat xarr] = oases_weightedKernel(clv,pS,x)
%
% Define variables:
%  output:
