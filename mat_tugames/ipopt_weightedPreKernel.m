function [x, Lerr, smat, xarr]=ipopt_weightedPreKernel(v,pS,x)
% IPOPT_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element 
...
%
%
% Usage: [x Lerr smat xarr]=ipopt_weightedPreKernel(v,pS,x)
%
% Define variables:
%  output:
