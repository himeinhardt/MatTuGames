function vi=InessGame(x)
% INESSRGAME recovers from the Shapley-value/payoff of a default game the
% corresponding inessential game. The inessential game vi has x as
% its Shapley value. Reverse operation of the function DecomposeGame(). 
% For n>12 this function needs some time to complete.
%
% Usage: vi=InessGame(x)
%
% Define variables:
