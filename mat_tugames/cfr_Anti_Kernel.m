function [x, Lerr, smat, xarr]=cfr_Anti_Kernel(v,F,x)
% CFR_ANTI_KERNEL computes from (v,x) an anti kernel element with coalition formation restrictions using
% Matlab's Optimization Toolbox.
%
% Usage: [x Lerr smat xarr] = cfr_Anti_Kernel(v,F,x)
%
% Define variables:
%  output:
