function [nPGI,PV]=NetworkPGI(E,th,w)
% NETWORKPGI computes the network public good index from the set of minimal winning coalitions of a network E
% while impossing a threshold of th.
%
% Source: M. Holler and F. Rupp, Power in Networks: The Medici,2020.
%
% Usage: nPGI=NetworkPGI(E,th)
% Define variables:
%  output:
...
elseif nargin < 3
   [~,mWC,~,n]=NetworkMajorityGame(E,th);
else
   [~,mWC,~,n]=NetworkMajorityGame(E,th,w);
end
