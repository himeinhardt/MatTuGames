function [x, Lerr, smat, xarr]=weightedAnti_PreKernel(v,pS,x)
...
%
% Usage: [x Lerr smat xarr]=weightedAnti_PreKernel(v,pS,x)
%
% Define variables:
%  output:
...
[x, Lerr, smat, xarr]=computeAntiPrk(v,x,pS,smc,0);
smat=tril(smat,-1)+triu(smat,1);

% Main function to compute a
% pre-kernel element.
%-----------------------------
function [x, Lerr, smat, xarr]=computeAntiPrk(v,x,pS,smc,slv)
% 
%  output:  -- as above.
%
%  input:
