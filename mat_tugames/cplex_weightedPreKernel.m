function [x, Lerr, smat, xarr]=cplex_weightedPreKernel(v,pS,x)
% CPLEX_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using cplexmex.
% Source: Meinhardt, 2010.
%
% CPLEX-Solver: http://www-01.ibm.com/software/websphere/ilog/
%
%
% Usage: [x Lerr smat xarr] = cplex_weightedPreKernel(v,pS,x)
%
% Define variables:
%  output:
