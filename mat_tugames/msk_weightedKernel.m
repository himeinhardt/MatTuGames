function [x, Lerr, smat, xarr]=msk_weightedKernel(v,pS,x)
% MSK_WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using mosekmex.
% Source: Meinhardt, 2010.
%
% MSK-Solver: http://www.mosek.com/  
%
% Usage: [x Lerr smat xarr] = msk_weightedKernel(v,pS,x)
%
% Define variables:
%  output:
...
%
%  Record of revisions:
%   Date              Version         Programmer   Change
%   ====================================================
%   07/04/2014        0.5             hme
%   05/15/2022        1.9.1           hme
%   01/28/2024        1.9.1           hme          conic
%                
