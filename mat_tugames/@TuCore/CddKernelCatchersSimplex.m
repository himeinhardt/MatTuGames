...
%                Then invoke
%
%                CddKernelCatchersSimplex(v,'all',vw_pt,'17')
%
...
[~,~,imp_vol,Pip]=clv.CddImputationSimplexVertices;
if core_sol==1
  [~,~,cr_vol,Pv]=clv.CddCoreSimplexVertices;
end
[~,~,rs_vol,Prea]=clv.CddReasonableSetSimplexVertices;
[~,~,prs_vol,Pprea]=clv.CddUpperSetSimplexVertices;
sma=clv.smallest_amount;
lwseQ=sum(sma)>v(N);
if lwseQ==1
else
  [~,~,lws_vol,Plws]=clv.CddLowerSetSimplexVertices;
end
