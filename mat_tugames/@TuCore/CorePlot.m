function CorePlot(varargin)
% COREPLOT plots at most a two (three) dimensional core in case of a 
...
elseif zov(N)==0
  error('Value of grand coalition is zero. No division is possible!.');
else
end
