function PS=psstar_gameQ(v,tol)
% PSSTAR_GAMEQ checks whether the game v is a PS* game, if so the
% pre-nucleolus and the Shapley value coincide.
%
% Source: C. Chang and Y-C. Tseng (GEB 71; pp 304-314; 2011)
%
% Usage: PS=psstar_gameQ(v,tol)
% 
% Define variables:
% output:
