function asd_vl=SolidarityShapleyValue(v,cs)
% SOLIDARITYSHAPLEY computes the solidarity Shapley value w.r.t. 
% the coalition structure cs.    
%
% Usage: sh_cs=SolidarityShapleyValue(clv,cs)
%
% Define variables:
%  output:
%  asd_vl   -- The solidarity Shapley value for coalition structure cs.
%
%  input:
