function [x, Lerr, smat, xarr]=cp_kernel(v,x)
% CP_KERNEL computes from (v,x) a Kernel element using the cone programming solver of
...
%
%
% Usage: [x Lerr smat xarr] = cp_kernel(v,x)
%
% Define variables:
%  output:
