function [core_vert,crst,cr_vol,P]=CddAntiCoreSimplexVertices(v,tol)
...
%
% Usage: [core_vert,crst,cr_vol,P]=CddAntiCoreSimplexVertices(v)
% Define variables:
%  output:
%  core_vert  -- Matrix of anti-core vertices. Output is numeric.
%  crst       -- The anti-core constraints.
%  cr_vol     -- Anti-core volume, if the anti-core is full dimensional,
%                otherwise zero. 
