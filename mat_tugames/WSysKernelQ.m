function [cQ,wpk_v,wpkQ,pkQ_wex]=WSysKernelQ(v,pS,x,tol)
...
%
% Usage: [cQ,wpn_v,nwex,wexQ]=WSysKernelQ(v,pS,tol) 
%
% Define variables:
%  output:
...
if isempty(x)
  wpk_v=weightedKernel(v,pS);
else
  wpk_v=x;
end

wpkQ=weightedKernelQ(v,wpk_v,pS);
