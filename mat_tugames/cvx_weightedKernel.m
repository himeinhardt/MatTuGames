function [x, Lerr, smat, xarr]=cvx_weightedKernel(v,pS,x)
% CVX_WEIGTHEDKERNEL computes from (v,x) a weighted kernel element using CVX.
...
%
% Usage: [x Lerr smat xarr] = cvx_weightedKernel(v,pS,x)
%
% Define variables:
%  output:
