function ERGPQ=EC_RGP_Q(v,x,str,tol)
%ECRGPQ checks whether the solution x satisfies excess comparability for each reduced game.
%
%
...
%
% Usage: ERGPQ=EC_RGP_Q(v,x,str,tol) 
%
% Define variables:
%
%  output:
