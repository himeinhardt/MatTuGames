function [x, Lerr, smat, xarr]=gurobi_prekernel(v,x)
% GUROPI_PREKERNEL computes from (v,x) a pre-kernel element using gurobimex.
% Source: Meinhardt, 2010.
%
% GUROPI-SOLVER: http://www.gurobi.com
%
%
% Usage: [x Lerr smat xarr] = gurobi_prekernel(v,x)
%
% Define variables:
%  output:
