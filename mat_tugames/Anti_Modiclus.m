function [x1, fmin]=Anti_Modiclus(v,tol)
% ANTI_MODICLUS computes the anti modiclus of game v using the optimization toolbox.
% Requires Dual-Simplex (Matlab R2015a).
%
% Usage: [x, fmin]=Anti_Modiclus(v,tol)
% Define variables:
%  output:
%  x1        -- The anti modiclus of game v.
%  fmin      -- The maxmin bi-excess value.
%
%  input:
...
while 1
  ...
  x1=x;
  if isempty(x1) == 1
     warning('Prn:Exit0','Probably no anti modiclus found!')
     x1=y;
     break;
  end
  x1(end)=[];
