function [nDPPI,PV]=NetworkDeeganPackel(E,th,w)
% NETWORKDeeganPackel computes the network Deegan-Packel index from the set of winning coalitions of a network E
