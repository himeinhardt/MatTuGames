function [x1, fmin]=weightedNucl(v,pS,tol)
% WEIGHTEDNUCL computes a weighted nucleolus of game v using the optimization toolbox.
% Uses now Dual-Simplex (Matlab R2015a).
%
% Usage: [x, fmin]=weightedNucl(v,pS,tol)
% Define variables:
%  output:
