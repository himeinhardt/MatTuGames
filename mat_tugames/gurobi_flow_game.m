function [v,x]=gurobi_flow_game(E,c,ow)
% GUROBI_FLOW_GAME computes from a flow problem (E,c,ow) a TU flow game using gurobimex.
% 
% GUROPI-SOLVER: http://www.gurobi.com 
%
% Usage: v=gurobi_flow_game(E,c,ow)
%
% Define variables:
% output:
