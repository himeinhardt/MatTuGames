function [CRGP CRGPC]=Converse_RGP_Q(v,x,str,tol)
...
%
% Usage [CRGP CRGPC]=Converse_RGP_Q(v,x,str,tol)
% Define variables:
%  output: Fields
...
sV_x{1,k}=x;
 if strcmp(str,'SHAP')
   vS{1,k}=HMS_RedGame(v,x,cl2(k),'SHAP'); %Hart-MasColell reduced game.
