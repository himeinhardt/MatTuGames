function [x, Lerr, smat, xarr]=msk_weightedPreKernel(v,pS,x)
% MSK_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using mosekmex.
% Source: Meinhardt, 2010.
%
% MSK-Solver: http://www.mosek.com/  
%
% Usage: [x Lerr smat xarr] = msk_weightedPreKernel(v,pS,x)
%
% Define variables:
%  output:
