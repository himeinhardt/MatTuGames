function [x, Lerr, smat, xarr]=weightedKernel(v,pS,x)
% WEIGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using
% Matlab's Optimization Toolbox.
% Source: Meinhardt, 2010.
%
% Usage: [x Lerr smat xarr] = weightedKernel(v,pS,x)
%
% Define variables:
%  output:
...
% Setting optins
    ...
    if abs(fval-ofval)<tol  && exitflag ~= 1
       x=x';
