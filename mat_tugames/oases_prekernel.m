function [x, Lerr, smat, xarr]=oases_prekernel(v,x)
% OASES_PREKERNEL computes from (v,x) a pre-kernel element using qpOASESmex 
...
%
%
% Usage: [x Lerr smat xarr] = oases_prekernel(v,x)
%
% Define variables:
%  output:
