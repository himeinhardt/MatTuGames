function [x1, alp]=msk_prenucl(v,tol)
% MSK_PRENUCL computes the pre-nucleolus of game v using mosekmex.
% 
% MSK-SOLVER: http://www.mosek.com/
%
% Usage: [x, alp]=msk_prenucl(v,tol)
% Define variables:
%  output:
...
% not setting imposes round-off errors.
