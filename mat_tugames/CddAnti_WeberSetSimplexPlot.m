function CddAnti_WeberSetSimplexPlot(varargin)
% CDDANTI_WEBERSETSIMPLEXPLOT plots the Weber set of game v, 
%
% Requires the Multi-Parametric Toolbox 3
% http://people.ee.ethz.ch/~mpt/3/
%
% Usage: CddAnti_WeberSetPlotSimplex(varargin)
% Define variables:
%  output:
%          -- A plot of the anti-Weber set of game v, it is identical to the 
%             Weber set.
%
...
%                Then invoke
%
%                CddAnti_WeberSetSimplexPlot(v,'all',vw_pt)
%
