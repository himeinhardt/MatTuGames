function [x, Lerr, smat, xarr]=gurobi_weightedPreKernel(v,pS,x)
% GUROPI_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using gurobimex.
% Source: Meinhardt, 2010.
%
% GUROPI-SOLVER: http://www.gurobi.com
%
%
% Usage: [x Lerr smat xarr] = gurobi_weightedPreKernel(v,pS,x)
%
% Define variables:
%  output:
