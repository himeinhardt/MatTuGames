function [x, Lerr, smat, xarr]=cp_prekernel(v,x)
% CP_PREKERNEL computes from (v,x) a pre-kernel element using the cone programming solver of
% MATLAB's Optimization Toolbox.
% Source: Meinhardt, 2013.
%
% CONE-Solver: coneprog  (R2020b) 
%
% Usage: [x Lerr smat xarr] = cp_prekernel(v,x)
%
% Define variables:
%  output:
