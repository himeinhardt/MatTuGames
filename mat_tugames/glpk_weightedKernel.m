function [x, Lerr, smat, xarr]=glpk_weightedKernel(v,pS,x)
% GLPK_WIEGHTEDKERNEL computes from (v,pS,x) a weighted kernel element using glpkmex.
% Source: Meinhardt, 2010.
%
% http://www.gnu.org/software/glpk/glpk.html
%
%
% Usage: [x Lerr smat xarr] = glpk_weightedKernel(v,pS,x)
%
% Define variables:
%  output:
