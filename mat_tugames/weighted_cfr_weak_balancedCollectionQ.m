function [bcQ, cmat, S]=weighted_cfr_weak_balancedCollectionQ(v,x,F,pS,tol)
% WEIGHTED_WEAK_BALANCEDCOLLECTIONQ verifies whether the set of induced
...
% 
%
% Usage: bcQ=weighted_cfr_weak_balancedCollectionQ(v,x,F,pS,tol)
% Define variables:
%  output:
