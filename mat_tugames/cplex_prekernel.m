function [x, Lerr, smat, xarr]=cplex_prekernel(v,x)
% CPLEX_PREKERNEL computes from (v,x) a pre-kernel element using cplexmex.
% Source: Meinhardt, 2010.
%
% CPLEX-Solver: http://www-01.ibm.com/software/websphere/ilog/
%
%
% Usage: [x Lerr smat xarr] = cplex_prekernel(v,x)
%
% Define variables:
%  output:
%  x        -- A pre-kernel element (output)
