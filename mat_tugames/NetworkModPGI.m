function [nPGI,PV]=NetworkModPGI(E,th,w)
% NETWORKMODPGI computes the network modified public good index from the set of winning coalitions of a network E
% while imposing a threshold of th. This avoids the violation of local monotonicity (Holler, 2018).
%
% Source: M. Holler and F. Rupp, Power in Networks: The Medici,2020.
%         
%
% Usage: nPGI=NetworkModPGI(E,th)
% Define variables:
%  output:
...
elseif nargin < 3
   [~,~,WC,n,E]=NetworkMajorityGame(E,th);
else
   [~,~,WC,n,E]=NetworkMajorityGame(E,th,w);
end
pl=1:n;
