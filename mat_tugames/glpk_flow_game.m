function [v,x]=glpk_flow_game(E,c,ow)
% GLPK_FLOW_GAME computes from a flow problem (E,c,ow) a TU flow game.
%
% Usage: v=gplk_flow_game(E,c,ow)
%
% Define variables:
% output:
