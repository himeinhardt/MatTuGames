function [x, Lerr, smat, xarr]=qrg_weightedPreKernel(v,pS,x)
% QRG_WEIGHTDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using qrginv.
% Source: Meinhardt, 2010.
% Source2: An improved method for the computation of the Moore-Penrose inverse matrix
%
% Requires: qrginv and CXSparse. The latter can be obtained from
% http://www.cise.ufl.edu/research/sparse/SuiteSparse/
%
% Usage: [x Lerr smat xarr]=qrg_weightedPreKernel(v,pS,x)
%
% Define variables:
%  output:
