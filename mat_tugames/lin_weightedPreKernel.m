function [x, Lerr, smat, xarr]=lin_weightedPreKernel(v,pS,x)
% LIN_WEIGHTEDPREKERNEL computes from (v,pS,x) a weighted pre-kernel element using Matlab's linsolve.
% Source: Meinhardt, 2010.
%
%
% Usage: [x Lerr smat xarr]=lin_weightedPreKernel(v,pS,x)
%
% Define variables:
%  output:
