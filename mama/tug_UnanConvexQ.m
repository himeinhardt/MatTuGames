function SOL=tug_UnanConvexQ(hd)
% TUG verifies game solution/property with the Mathematica Package TuGames.
%
% Usage: SOL=tug_UnanConvexQ(hd)
% Define variables:
%  output:
%  SOL         -- Checks if the coordinates satisfy the sufficient and necessary condition of convexity
...
msvg=math('mbv=UnanConvexQ[coord,T]');
SOL=struct('ConvexQ',msvg);
math('quit')
